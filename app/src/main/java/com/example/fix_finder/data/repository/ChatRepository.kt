...
class ChatRepository(
    ...
    fun getOrCreateChat(clientId: String, providerId: String, onComplete: (String) -> Unit) {
        db.collection("chats")
            ...
            .addOnSuccessListener { result ->
                val chat = result.documents.firstOrNull {
                    ...
                    participants?.contains(providerId) == true
                }
                ...
                if (chat != null) {
                    ...
                    // Create new chat
                    val newChat = mapOf(
                        "participants" to listOf(clientId, providerId),
                        "lastMessage" to "",
    ...
    fun sendMessage(chatId: String, senderId: String, recipientId: String, text: String) {
        ...
        db.runBatch { batch ->
            ...
            batch.update(chatRef, mapOf(
                ...
                "${recipientId}_unseenCount" to com.google.firebase.firestore.FieldValue.increment(1)
            ))
        }
        ...
        db.collection("chats").document(chatId)
            ...
            .addSnapshotListener { snapshot, _ ->
                if (snapshot != null) {
                    ...
                    // Update delivery status if current user is the recipient
                    messages.filter {
